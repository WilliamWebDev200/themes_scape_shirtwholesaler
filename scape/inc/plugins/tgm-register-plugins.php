...
function wtbx_required_plugins() {
    ...
    $plugins = array(
	    array(
		    ...
		    'source'             => 'http://whiteboxstud.io/envato/scape/dist/229162/scape-core.zip', // The plugin source.
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		    'version'            => '1.4.9', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
	    ...
	    array(
		    ...
		    'source'             => 'http://whiteboxstud.io/envato/scape/dist/229162/js_composer.zip', // The plugin source.
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		    'version'            => '6.3', // E.g. 1.0.0. If set, the active plugin must be this version or higher.
		    'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
		    'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
	    ...
	    array(
		    ...
		    'source'             => 'http://whiteboxstud.io/envato/scape/dist/229162/revslider.zip', // The plugin source.
	    ...
	    array(
		    ...
		    'source'             => 'http://whiteboxstud.io/envato/scape/dist/229162/envato-market.zip', // The plugin source.
		    'required'           => false, // If false, the plugin is only 'recommended' instead of required.
