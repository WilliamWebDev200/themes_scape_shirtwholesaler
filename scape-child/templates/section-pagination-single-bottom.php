...
if ( $nav_layout === 'bottom' || $nav_layout === 'sticky' || $nav_layout === 'image' ) {
	...
	<div class="wtbx-navigation-wrapper <?php echo esc_attr($post_type); ?>-nav-wrapper wtbx-page-nav-wrapper wtbx-layout-<?php echo esc_attr($nav_layout); ?>">
		<nav class="shirtwolesaler-blog-detail__next-prev wtbx-navigation <?php echo esc_attr($post_type); ?>-nav wtbx-page-nav wtbx-skin-<?php echo esc_attr($skin); ?>">
			<div class="wtbx-nav-inner shirtwolesaler-blog-detail__next-prev--wrapper <?php echo esc_attr($post_type); ?>-nav-inner row-inner clearfix">
				<ul class="wtbx-col-sm-12 wtbx-nav-column">
					...
					if ( !empty($buttons) ) :
						previous_post_link(
							'<li class="wtbx-nav-prev '.$post_type.'-prev clearfix wtbx-element-reveal wtbx-reveal-cont shirtwolesaler-blog-detail__next-prev--item shirtwolesaler-blog-detail__next-prev--prev">%link</li>',
						...
						next_post_link(
							'<li class="wtbx-nav-next '.$post_type.'-prev clearfix wtbx-element-reveal wtbx-reveal-cont shirtwolesaler-blog-detail__next-prev--item shirtwolesaler-blog-detail__next-prev--next">%link</li>',
