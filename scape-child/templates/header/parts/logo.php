...
<div class="header-shirtwolesaler__top" style="display:none">
	<div class="header-shirtwolesaler__logo wtbx_header_logo_wrapper<?php echo esc_attr($has_sticky_logo); ?>">
