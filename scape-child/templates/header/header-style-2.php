...
<div id="header-wrapper" class="header-shirtwolesaler header-desktop header-wrapper header-style-<?php echo esc_attr($header_style . $layout . $borders . $header_skin_class . $header_sticky . $sticky_skin_class . $animation . $shadow_class); ?>">
	<div id="header-container" class="clearfix">
		<?php
		if ( $sections !== '' ) {
			foreach ($sections as $section => $areas) { ?>
				<div class="header-shirtwolesaler__section wtbx_hs wtbx_hs_<?php echo esc_attr($section); ?>">
					<div class="wtbx_hs_inner header-shirtwolesaler__holder">
							<?php
							if ( $section === 'header' ) {
								include(locate_template('templates/header/parts/logo.php'));
							}
						foreach ($areas as $area => $items) { ?>
							<div class="header-shirtwolesaler__navigation wtbx_ha wtbx_ha_<?php echo esc_attr($section); ?>_<?php echo esc_attr($area); ?> clearfix"><?php
